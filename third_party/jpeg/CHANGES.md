...
Version 8c of the Jpeg Library was downloaded from [jpegsr8c.zip](http://www.ijg.org/files/jpegsr8c.zip).

As required by the libjpeg license, additions, deletions and changes to the original files are listed here.
Files noted as "Only in jpeg-8c" were deleted; files noted as "Only in third_party/jpeg" were added. The
change list was generated by running the command `diff -w -ru jpeg-8c third_party/jpeg`
