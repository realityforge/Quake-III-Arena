...
This is a stripped down version of the "Independent JPEG Group's JPEG software" release 8c release on 16-Jan-2011.
The library was downloaded from [jpegsr8c.zip](http://www.ijg.org/files/jpegsr8c.zip). As required by the license,
additions, deletions and changes to the original files are listed here. Files noted as "Only in jpeg-8c" were deleted;
files noted as "Only in third_party/jpeg" were added. The change list was generated by running the command 

> $ diff -w -ru jpeg-8c third_party/jpeg
...
Only in third_party/jpeg: jconfig.h
...
Only in jpeg-8c: jdosabcc.obj
Only in jpeg-8c: jdosamsc.obj
Only in jpeg-8c: jdosaobj.txt
diff -w -ru jpeg-8c/jerror.c third_party/jpeg/jerror.c
--- jpeg-8c/jerror.c	1998-02-21 21:03:16.000000000 +1100
+++ third_party/jpeg/jerror.c	2022-02-11 08:38:08.000000000 +1100
@@ -24,6 +24,8 @@
 #include "jversion.h"
 #include "jerror.h"
...
Only in jpeg-8c: README
Only in jpeg-8c: readme.dos
