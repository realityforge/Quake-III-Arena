...
SDLLIBSDIR=${SDLHDIR}/libs
VORBISDIR=third_party/vorbis
ZDIR=third_party/zlib
...
$(STRINGIFY): $(RGL2DIR)/glsl/stringify.c
	$(echo_cmd) "TOOLS_CC $@"
	$(Q)$(TOOLS_CC) $(TOOLS_CFLAGS) $(TOOLS_LDFLAGS) -o $@ $(RGL2DIR)/glsl/stringify.c $(TOOLS_LIBS)
