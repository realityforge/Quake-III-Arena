...
textures/test/rnd_ledm1
{
        ...
        surfaceparm trans
        qer_trans 0.5
        qer_editorimage textures/test/rnd_ledm1

        {
                map textures/test/rnd_ledm1
                blendFunc GL_ONE GL_ONE
                rgbGen identity
        }
        {
                map textures/test/rnd_ledm2
...
textures/test/electricity3
	{
		...
		{
			map textures/test/electricity9
...
textures/gothic_trim/hellodolly
{
	...
	//	*************************************************
		...
		qer_editorimage	textures/gothic_trim/metalbase13_d
		...
		{
			map textures/gothic_trim/metalbase13_d
			// Name of border wall
			blendFunc GL_SRC_ALPHA GL_ONE_MINUS_SRC_ALPHA
		}
...
textures/test/blocks10pent
{
	...
	{
		clampmap textures/test/jumppadsmall
		blendfunc gl_one gl_one
...
textures/dont_use/sign_test_glow
{
	...
	{
		map textures/dont_use/sign_test
		alphaMap $fromBlack
		blendFunc GL_ONE GL_ONE
	}

	{
		map textures/dont_use/sign_test_glow
		alphaMap $fromBlack
		blendFunc GL_ONE GL_ONE
...
//	*************************************************
	...
	{
		map textures/dont_use/strangesky3_kc
		tcMod scroll  .03 .03
	}


	{
		map textures/dont_use/strangesky
		blendfunc GL_ONE GL_SRC_COLOR
		tcMod scroll  .05 .05
	}
	...
	{
		map textures/dont_use/strangesky2_kc
...
//	*************************************************
	...
	{
		map textures/dont_use/tileclouds3_kc
		tcMod scroll 0.01 0.01
		tcMod scale 2 2
	}
	...
	{
		map textures/dont_use/tileclouds4_kc
		blendFunc GL_ONE GL_ONE
		tcMod scroll  .04 .05
	}
	...
	{
		map textures/dont_use/tileclouds3b_kc
		blendFunc GL_DST_COLOR GL_ONE
...
textures/dont_use/openwindow
{
	...
	{
	map textures/dont_use/openwindow
	alphaMap openwindow
...
textures/dont_use/metal2_2kc
{
	...
	cull none
	{
	map textures/dont_use/metal2_2kc
	alphaMap $fromBlack
	blendFunc GL_ONE_MINUS_SRC_ALPHA GL_SRC_ALPHA
	depthWrite
	}
...
textures/dont_use/rustysupport
{
	...
	cull none
	{
	map textures/dont_use/rustysupport
	alphaMap $fromBlack
	blendFunc GL_ONE_MINUS_SRC_ALPHA GL_SRC_ALPHA
	depthWrite
	}
...
//	*************************************************
	...
	{
	map textures/dont_use/slimetest7c
	blendfunc GL_ONE_MINUS_DST_COLOR GL_ZERO
	tcMod turb .01 .2 10 0.01
	tcMod scroll  .2 .1
	}
	{
	map textures/dont_use/bubbleslimeelectricc
	blendfunc GL_DST_COLOR GL_ONE
...
//	*************************************************
	...
	{
	map textures/dont_use/firetestb
	blendfunc gl_one gl_one
	tcMod scroll 5 15
	tcMod scale .25 .25
	tcMod turb .2 .2 .1 1
	...
	{
	map textures/dont_use/firetest
	...
	{
	map textures/dont_use/firetest2
	blendFunc GL_dst_color gl_one
	tcMod scroll  10 50
	tcMod turb .1 .1 .5 .5
	rgbGen wave SIN .5 .5 1 .1
...
//	*************************************************
	...
	{
	map textures/test/slimetest6
	tcMod turb .25 0.1 1 0.02
	tcMod scroll  .2 .2
	}
	{
	map textures/test/slimecrust5d
	blendfunc GL_DST_COLOR GL_SRC_ALPHA
	tcMod turb .5 .5 1 .02
	tcMod scroll .1 .01
	tcMod scale .1 .1
	...
	{
	map textures/test/electricslime
	tcMod turb 1 1 1 .01
	tcMod scroll 1 5
	tcMod scale .5 .5
	blendfunc GL_ONE GL_ONE
...
//	*************************************************
	...
	{
	map textures/test/lavatest
	tcMod turb .25 0.1 1 0.02
	tcMod scroll  .2 .2
	}
	{
	map textures/test/lavacrust
	blendfunc GL_DST_COLOR GL_SRC_ALPHA
...
//	**************************************************
	...
	{
	map textures/test/watertest12e
	blendfunc GL_DST_COLOR GL_ONE
	tcMod scale .2 .2
	...
	{
	map textures/test/watertest12e7
	blendfunc GL_DST_COLOR GL_ONE
	tcMod turb .1 .1 0 .01
	tcMod scale .5 .5
	tcMod scroll -.025 .02
	...
	{
	map textures/test/watertest12e6
	blendfunc GL_DST_COLOR GL_ONE
	tcMod scale .3 .3
...
//	*************************************************
	...
	{
	map textures/paulbase/tilefloor2
	}
	//{
	//map textures/test/watertest7f
	//blendFunc GL_ONE GL_SRC_COLOR
	//tcMod turb .01 .02 0 0.05
	//tcMod scroll .01 .01
	//}
	//{
	//map textures/test/watertest7h
	//blendFunc GL_ONE GL_SRC_COLOR
...
//	*************************************************
	...
	{
	map textures/test/watertest10f
	blendfunc GL_DST_COLOR GL_SRC_COLOR
	tcMod turb .01 .01 0 0.1
...
//	*************************************************
	...
	{
	map  textures/test/watertest10c
	blendFunc GL_ONE GL_SRC_ALPHA
...
textures/test/fire2
{
	...
	{
	map textures/test/fire2
	}
	{
	map textures/test/fire3
	tcMod turb 0 .1 0 .7
	tcMod scroll  0 10
	rgbGen wave sin 1 2 0 1
	}
	{
	map textures/test/fire3.blend
	blendfunc GL_ONE GL_ONE
	tcMod scroll  0 10
	}
}
...
textures/bwhtest/lightning
{
	cull disable
	{
	map textures/bwhtest/lightning
	blendfunc GL_ONE GL_ONE
...
{
	{
	map textures/bwhtest/crackedearth
	}
}
