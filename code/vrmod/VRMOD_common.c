...
void drawQuad(vec3_t point0, vec3_t point1, vec3_t point2, vec3_t point3, const float s1, const float t1, const float s2, const float t2, const byte color[4])
{
    ...
    *(unsigned int*)&tess.vertexColors[ndx0] = *(unsigned int*)&tess.vertexColors[ndx1] = *(unsigned int*)&tess.vertexColors[ndx2] = *(unsigned int*)&tess.vertexColors[ndx3] = *(unsigned int*)color;
