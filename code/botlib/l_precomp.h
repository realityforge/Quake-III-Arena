...
void QDECL SourceError(source_t* source, const char* str, ...) PRINTF_LIKE_FUNCTION(2, 3);
// print a source warning
void QDECL SourceWarning(source_t* source, const char* str, ...) PRINTF_LIKE_FUNCTION(2, 3);
