...
typedef struct {
  /*
      int			x, y, width, height;
          ...
          int			time;				// time in
     milliseconds for shader effects and other time dependent rendering issues
          int			rdflags;			// RDF_NOWORLDMODEL,
     etc
...
typedef struct {
  ...
  //	cplane_t	portalPlane;		// clip anything behind this if
  //mirroring
