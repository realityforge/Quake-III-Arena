...
struct GlobalPipelineManager {
  ...
  // dim 0 is based on fogPass_t: 0 - corresponds to FP_EQUAL, 1 - corresponds
  // to FP_LE. dim 1 is directly a cullType_t enum value. dim 2 is a polygon
  // offset value (0 - off, 1 - on).
