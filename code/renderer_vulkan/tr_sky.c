...
void RB_StageIteratorSky(void) {
  ...
  if (tess.shader->sky.outerbox[0] &&
    ...
    for (i = 0; i < 6; i++) {
      ...
      updateCurDescriptor(
          tess.shader->sky.outerbox[sky_texorder[i]]->descriptor_set, 0);
      ...
      {
        float skybox_translate[16] QALIGN(16) = {1,
                                                 0,
                                                 0,
                                                 0,
                                                 0,
      ...
      vk_shade_geometry(g_stdPipelines.skybox_pipeline, VK_FALSE,
                        r_showsky->integer ? DEPTH_RANGE_ZERO : DEPTH_RANGE_ONE,
                        VK_TRUE);
    }
  }
