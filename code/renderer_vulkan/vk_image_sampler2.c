...
/*
  ...
  maxSamplerAllocationCount member of the VkPhysicalDeviceLimits structure. If
  maxSamplerAllocationCount is exceeded, vkCreateSampler will return
...
VkSampler vk_find_sampler(VkBool32 mipmap, VkBool32 repeat_texture) {
  ...
  VkSamplerAddressMode address_mode =
      repeat_texture ? VK_SAMPLER_ADDRESS_MODE_REPEAT
  ...
  qboolean max_lod_0_25 = qfalse; // used to emulate OpenGL's
                                  // GL_LINEAR/GL_NEAREST minification filter
