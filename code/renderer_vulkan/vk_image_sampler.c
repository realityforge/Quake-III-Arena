...
VkSampler vk_find_sampler(VkBool32 isMipmap, VkBool32 isRepeatTexture) {
  ...
  // used. VK_SAMPLER_ADDRESS_MODE_CLAMP_TO_EDGE specifies that the clamp to
  // edge wrap mode will be used. specifying the behavior of sampling with
  // coordinates outside the range [0,1] for the respective u, v, or w
  // coordinate as defined in the Wrapping Operation section
  VkSamplerAddressMode address_mode =
      isRepeatTexture ? VK_SAMPLER_ADDRESS_MODE_REPEAT
