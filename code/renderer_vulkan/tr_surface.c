...
void RB_AddQuadStampExt(vec3_t origin, vec3_t left, vec3_t up, byte *color,
  ...
  tess.normal[ndx0][0] = tess.normal[ndx1][0] = tess.normal[ndx2][0] =
      tess.normal[ndx3][0] = normal[0];
  tess.normal[ndx0][1] = tess.normal[ndx1][1] = tess.normal[ndx2][1] =
      tess.normal[ndx3][1] = normal[1];
  tess.normal[ndx0][2] = tess.normal[ndx1][2] = tess.normal[ndx2][2] =
