...
static int R_MDRCullModel(mdrHeader_t *header, trRefEntity_t *ent) {
  ...
  mdrFrame_t *newFrame = (mdrFrame_t *)((byte *)header + header->ofsFrames +
...
static int R_MDRComputeFogNum(mdrHeader_t *header, trRefEntity_t *ent) {
  ...
  mdrFrame_t *mdrFrame = (mdrFrame_t *)((byte *)header + header->ofsFrames +
                                        frameSize * ent->e.frame);
...
void R_MDRAddAnimSurfaces(trRefEntity_t *ent) {
  ...
  mdrSurface_t *surface =
      (mdrSurface_t *)((unsigned char *)lod + lod->ofsSurfaces);
