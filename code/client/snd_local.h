...
typedef struct {
  ...
  int fullsamples; // samples with all channels in buffer (samples divided by
                   // channels)
...
typedef struct {
  ...
  void (*RawSamples)(int stream, int samples, int rate, int width, int channels,
...
void S_PaintChannelFrom16_altivec(
    portable_samplepair_t paintbuffer[PAINTBUFFER_SIZE], int snd_vol,
