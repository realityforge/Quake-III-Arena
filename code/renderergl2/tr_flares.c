...
void RB_RenderFlare(flare_t *f) {
  ...
  */
   ...
   * decrease the intensity to achieve a reasonable visual result. The intensity
   * is ~ (size^2 / distance^2) which can be got by considering the ratio of
   * (flaresurface on screen) : (Surface of sphere defined by flare origin and
   * distance from flare) An important requirement is: intensity <= 1 for all
   * distances.
   *
