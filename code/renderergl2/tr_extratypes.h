...
// tr_extratypes.h, for mods that want to extend tr_types.h without losing
// compatibility with original VMs

// extra refdef flags start at 0x0008
#define RDF_NOFOG                                                              \
  0x0008 // don't apply fog to polys added using RE_AddPolyToScene
