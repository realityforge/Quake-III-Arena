...
void R_LoadJPG(const char* name, byte** image_buffer, uint32_t* width, uint32_t* height);
void R_LoadPNG(const char* name, byte** image_buffer, uint32_t* width, uint32_t* height);
