...
// https://gist.github.com/rygorous/16796a0c876cf8a5f542caddb55bce8a get missing
// functions from code/SDL2/include/SDL_opengl.h
...
#define QGL_1_1_PROCS                                                          \
  ...
  GLE(void, ClearColor, GLclampf red, GLclampf green, GLclampf blue,           \
      GLclampf alpha)                                                          \
  GLE(void, Clear, GLbitfield mask)                                            \
  GLE(void, ClearStencil, GLint s)                                             \
  GLE(void, ColorMask, GLboolean red, GLboolean green, GLboolean blue,         \
      GLboolean alpha)                                                         \
  GLE(void, CopyTexSubImage2D, GLenum target, GLint level, GLint xoffset,      \
  ...
  GLE(void, ReadPixels, GLint x, GLint y, GLsizei width, GLsizei height,       \
...
#define QGL_1_1_FIXED_FUNCTION_PROCS                                           \
  ...
  GLE(void, ColorPointer, GLint size, GLenum type, GLsizei stride,             \
      const GLvoid *ptr)                                                       \
  ...
  GLE(void, TexCoordPointer, GLint size, GLenum type, GLsizei stride,          \
      const GLvoid *ptr)                                                       \
  GLE(void, TexEnvf, GLenum target, GLenum pname, GLfloat param)               \
  GLE(void, VertexPointer, GLint size, GLenum type, GLsizei stride,            \
      const GLvoid *ptr)
...
#define QGL_DESKTOP_1_1_FIXED_FUNCTION_PROCS                                   \
  ...
  GLE(void, End, void)                                                         \
  GLE(void, Frustum, GLdouble left, GLdouble right, GLdouble bottom,           \
      GLdouble top, GLdouble near_val, GLdouble far_val)                       \
  GLE(void, Ortho, GLdouble left, GLdouble right, GLdouble bottom,             \
      GLdouble top, GLdouble near_val, GLdouble far_val)                       \
...
#define QGL_ES_1_1_FIXED_FUNCTION_PROCS                                        \
  ...
  GLE(void, Frustumf, GLfloat left, GLfloat right, GLfloat bottom,             \
      GLfloat top, GLfloat near_val, GLfloat far_val)                          \
  GLE(void, Orthof, GLfloat left, GLfloat right, GLfloat bottom, GLfloat top,  \
      GLfloat near_val, GLfloat far_val)

// OpenGL 1.3, was GL_ARB_texture_compression
#define QGL_1_3_PROCS                                                          \
  GLE(void, ActiveTexture, GLenum texture)                                     \
  GLE(void, CompressedTexImage2D, GLenum target, GLint level,                  \
      GLenum internalformat, GLsizei width, GLsizei height, GLint border,      \
      GLsizei imageSize, const void *data)                                     \
  GLE(void, CompressedTexSubImage2D, GLenum target, GLint level,               \
...
#define QGL_2_0_PROCS                                                          \
  ...
  GLE(void, BindAttribLocation, GLuint program, GLuint index,                  \
      const GLchar *name)                                                      \
  ...
  GLE(void, GetActiveUniform, GLuint program, GLuint index, GLsizei bufSize,   \
      GLsizei *length, GLint *size, GLenum *type, GLchar *name)                \
  GLE(void, GetProgramiv, GLuint program, GLenum pname, GLint *params)         \
  GLE(void, GetProgramInfoLog, GLuint program, GLsizei bufSize,                \
      GLsizei *length, GLchar *infoLog)                                        \
  GLE(void, GetShaderiv, GLuint shader, GLenum pname, GLint *params)           \
  GLE(void, GetShaderInfoLog, GLuint shader, GLsizei bufSize, GLsizei *length, \
      GLchar *infoLog)                                                         \
  GLE(void, GetShaderSource, GLuint shader, GLsizei bufSize, GLsizei *length,  \
      GLchar *source)                                                          \
  GLE(GLint, GetUniformLocation, GLuint program, const GLchar *name)           \
  GLE(void, LinkProgram, GLuint program)                                       \
  GLE(void, ShaderSource, GLuint shader, GLsizei count, const GLchar **string, \
      const GLint *length)                                                     \
...
#define QGL_ARB_framebuffer_object_PROCS                                       \
  ...
  GLE(void, BlitFramebuffer, GLint srcX0, GLint srcY0, GLint srcX1,            \
      GLint srcY1, GLint dstX0, GLint dstY0, GLint dstX1, GLint dstY1,         \
      GLbitfield mask, GLenum filter)                                          \
  GLE(void, RenderbufferStorageMultisample, GLenum target, GLsizei samples,    \
...
#define QGL_EXT_direct_state_access_PROCS                                      \
  GLE(GLvoid, BindMultiTextureEXT, GLenum texunit, GLenum target,              \
      GLuint texture)                                                          \
  GLE(GLvoid, TextureParameterfEXT, GLuint texture, GLenum target,             \
      GLenum pname, GLfloat param)                                             \
  GLE(GLvoid, TextureParameteriEXT, GLuint texture, GLenum target,             \
      GLenum pname, GLint param)                                               \
  GLE(GLvoid, TextureImage2DEXT, GLuint texture, GLenum target, GLint level,   \
      GLint internalformat, GLsizei width, GLsizei height, GLint border,       \
      GLenum format, GLenum type, const GLvoid *pixels)                        \
  GLE(GLvoid, TextureSubImage2DEXT, GLuint texture, GLenum target,             \
      GLint level, GLint xoffset, GLint yoffset, GLsizei width,                \
      GLsizei height, GLenum format, GLenum type, const GLvoid *pixels)        \
  GLE(GLvoid, CopyTextureSubImage2DEXT, GLuint texture, GLenum target,         \
  ...
  GLE(GLvoid, CompressedTextureSubImage2DEXT, GLuint texture, GLenum target,   \
      GLint level, GLint xoffset, GLint yoffset, GLsizei width,                \
  ...
  GLE(GLvoid, ProgramUniform2fEXT, GLuint program, GLint location, GLfloat v0, \
      GLfloat v1)                                                              \
  GLE(GLvoid, ProgramUniform3fEXT, GLuint program, GLint location, GLfloat v0, \
      GLfloat v1, GLfloat v2)                                                  \
  GLE(GLvoid, ProgramUniform4fEXT, GLuint program, GLint location, GLfloat v0, \
      GLfloat v1, GLfloat v2, GLfloat v3)                                      \
  GLE(GLvoid, ProgramUniform1fvEXT, GLuint program, GLint location,            \
      GLsizei count, const GLfloat *value)                                     \
  GLE(GLvoid, ProgramUniformMatrix4fvEXT, GLuint program, GLint location,      \
      GLsizei count, GLboolean transpose, const GLfloat *value)                \
  GLE(GLvoid, NamedRenderbufferStorageEXT, GLuint renderbuffer,                \
      GLenum internalformat, GLsizei width, GLsizei height)                    \
  GLE(GLvoid, NamedRenderbufferStorageMultisampleEXT, GLuint renderbuffer,     \
      GLsizei samples, GLenum internalformat, GLsizei width, GLsizei height)   \
  GLE(GLenum, CheckNamedFramebufferStatusEXT, GLuint framebuffer,              \
      GLenum target)                                                           \
  GLE(GLvoid, NamedFramebufferTexture2DEXT, GLuint framebuffer,                \
      GLenum attachment, GLenum textarget, GLuint texture, GLint level)        \
  GLE(GLvoid, NamedFramebufferRenderbufferEXT, GLuint framebuffer,             \
...
#define QGL_VERSION_ATLEAST(major, minor)                                      \
  (qglMajorVersion > major ||                                                  \
   (qglMajorVersion == major && qglMinorVersion >= minor))
