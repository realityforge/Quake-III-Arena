...
EXPORT int vmMain(int command, int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8, int arg9, int arg10, int arg11)
{
    switch (command) {
        ...
        if (Q_stricmp(name, "StartServer") == 0) {
            ...
            if (String_Parse(args, &orders)) {
                ...
                if (selectedPlayer < uiInfo.myTeamCount) {
                    strncpyz(buff, orders, sizeof(buff));
...
static void UI_BuildServerDisplayList(const server_refresh_t refresh_action)
{
    ...
    if (len == 0) {
        strncpyz(uiInfo.serverStatus.motd, "Welcome to Team Arena!", sizeof(uiInfo.serverStatus.motd));
        len = strlen(uiInfo.serverStatus.motd);
    }
