...
{
    HANDLE(WINAPI * pAvSetMmThreadCharacteristicsW)
    (_In_ LPCWSTR TaskName, _Inout_ LPDWORD TaskIndex);
    BOOL(WINAPI * pAvRevertMmThreadCharacteristics)
