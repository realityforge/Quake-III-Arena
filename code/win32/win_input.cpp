...
struct Mouse {
	...
	virtual qbool Activate(qbool _active)
	{
		return qfalse;
	} // qtrue if successful
	...
	{
		return qfalse;
	} // qtrue if the event was handled
