...
static bool G_TryPushingProxMine(gentity_t* check, gentity_t* pusher, vec3_t move, vec3_t amove)
{
...
===============
*/
static void Touch_PlatCenterTrigger(gentity_t* ent, gentity_t* other, UNUSED trace_t* trace)
{
    if (!other->client) {
        return;
    }
