...
{
    if (maxs[0] < mins2[0] - BOUNDS_CLIP_EPSILON || maxs[1] < mins2[1] - BOUNDS_CLIP_EPSILON || maxs[2] < mins2[2] - BOUNDS_CLIP_EPSILON || mins[0] > maxs2[0] + BOUNDS_CLIP_EPSILON || mins[1] > maxs2[1] + BOUNDS_CLIP_EPSILON || mins[2] > maxs2[2] + BOUNDS_CLIP_EPSILON) {
        return qfalse;
    }
...
{
    if (maxs[0] < point[0] - BOUNDS_CLIP_EPSILON || maxs[1] < point[1] - BOUNDS_CLIP_EPSILON || maxs[2] < point[2] - BOUNDS_CLIP_EPSILON || mins[0] > point[0] + BOUNDS_CLIP_EPSILON || mins[1] > point[1] + BOUNDS_CLIP_EPSILON || mins[2] > point[2] + BOUNDS_CLIP_EPSILON) {
        return qfalse;
    }
