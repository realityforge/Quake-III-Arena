...
static memstatic_t emptystring = { { (sizeof(memblock_t) + 2 + 3) & ~3, TAG_STATIC, NULL, NULL, ZONEID }, { '\0', '\0' } };
...
#define CL(MacroVersion, RealVersion, Year) \
	{                                       \
		MacroVersion, RealVersion, Year     \
	}
