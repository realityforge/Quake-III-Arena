...
// same as rimm but doesn't die, returns 0 if not encodable so don't call with
// zero as argument!
...
#define BKPT(v)                                                                \
  (AL | 0b10010 << 20 | ((v & ~0xF) << 4) | 0b0111 << 4 | (v & 0xF))

#define YIELD (0b110010 << 20 | 0b1111 << 12 | 1)
#define NOP cond(AL, YIELD)

// immediate value must fit in 0xFF!
#define ANDi(dst, src, i)                                                      \
  (AL | (0b001 << 25) | (0b00000 << 20) | (src << 16) | (dst << 12) | rimm(i))
#define EORi(dst, src, i)                                                      \
  (AL | (0b001 << 25) | (0b00010 << 20) | (src << 16) | (dst << 12) | rimm(i))
#define SUBi(dst, src, i)                                                      \
  (AL | (0b001 << 25) | (0b00100 << 20) | (src << 16) | (dst << 12) | rimm(i))
#define RSBi(dst, src, i)                                                      \
  (AL | (0b001 << 25) | (0b00110 << 20) | (src << 16) | (dst << 12) | rimm(i))
#define ADDi(dst, src, i)                                                      \
  (AL | (0b001 << 25) | (0b01000 << 20) | (src << 16) | (dst << 12) | rimm(i))
#define ADCi(dst, src, i)                                                      \
  (AL | (0b001 << 25) | (0b01010 << 20) | (src << 16) | (dst << 12) | rimm(i))
#define SBCi(dst, src, i)                                                      \
  (AL | (0b001 << 25) | (0b01100 << 20) | (src << 16) | (dst << 12) | rimm(i))
#define RSCi(dst, src, i)                                                      \
  (AL | (0b001 << 25) | (0b01110 << 20) | (src << 16) | (dst << 12) | rimm(i))

#define ORRi(dst, src, i)                                                      \
  (AL | (0b001 << 25) | (0b11000 << 20) | (src << 16) | (dst << 12) | rimm(i))
#define MOVi(dst, i)                                                           \
  (AL | (0b001 << 25) | (0b11010 << 20) | (dst << 12) | rimm(i))
#define BICi(dst, src, i)                                                      \
  (AL | (0b001 << 25) | (0b11100 << 20) | (src << 16) | (dst << 12) | rimm(i))
#define MVNi(dst, i)                                                           \
  (AL | (0b001 << 25) | (0b11110 << 20) | (dst << 12) | rimm(i))

#define MOVW(dst, i)                                                           \
  (AL | (0b11 << 24) | ((((i) >> 12) & 0xF) << 16) | (dst << 12) |             \
   ((i) & ((1 << 12) - 1)))
#define MOVT(dst, i)                                                           \
  (AL | (0b11 << 24) | (0b0100 << 20) | ((((i) >> 12) & 0xF) << 16) |          \
   (dst << 12) | ((i) & ((1 << 12) - 1)))

#define TSTi(src, i)                                                           \
  (AL | (0b001 << 25) | (0b10001 << 20) | (src << 16) | rimm(i))
#define TEQi(src, i)                                                           \
  (AL | (0b001 << 25) | (0b10011 << 20) | (src << 16) | rimm(i))
#define CMPi(src, i)                                                           \
  (AL | (0b001 << 25) | (0b10101 << 20) | (src << 16) | rimm(i))
#define CMNi(src, i)                                                           \
  (AL | (0b001 << 25) | (0b10111 << 20) | (src << 16) | rimm(i))
...
#define AND(dst, src, reg)                                                     \
  (AL | (0b000 << 25) | (0b00000 << 20) | (src << 16) | (dst << 12) | reg)
#define EOR(dst, src, reg)                                                     \
  (AL | (0b000 << 25) | (0b00010 << 20) | (src << 16) | (dst << 12) | reg)
#define SUB(dst, src, reg)                                                     \
  (AL | (0b000 << 25) | (0b00100 << 20) | (src << 16) | (dst << 12) | reg)
#define RSB(dst, src, reg)                                                     \
  (AL | (0b000 << 25) | (0b00110 << 20) | (src << 16) | (dst << 12) | reg)
#define ADD(dst, src, reg)                                                     \
  (AL | (0b000 << 25) | (0b01000 << 20) | (src << 16) | (dst << 12) | reg)
#define ADC(dst, src, reg)                                                     \
  (AL | (0b000 << 25) | (0b01010 << 20) | (src << 16) | (dst << 12) | reg)
#define SBC(dst, src, reg)                                                     \
  (AL | (0b000 << 25) | (0b01100 << 20) | (src << 16) | (dst << 12) | reg)
#define RSC(dst, src, reg)                                                     \
  (AL | (0b000 << 25) | (0b01110 << 20) | (src << 16) | (dst << 12) | reg)

#define ORR(dst, src, reg)                                                     \
  (AL | (0b000 << 25) | (0b11000 << 20) | (src << 16) | (dst << 12) | reg)
#define MOV(dst, src) (AL | (0b000 << 25) | (0b11010 << 20) | (dst << 12) | src)

#define LSL(dst, src, reg)                                                     \
  (AL | (0b000 << 25) | (0b1101 << 21) | (0 << 20) | (dst << 12) |             \
   (reg << 8) | (0b0001 << 4) | src)
...
#define LSLi(dst, src, i)                                                      \
  (AL | (0b000 << 25) | (0b1101 << 21) | (0 << 20) | (dst << 12) |             \
   ((i & 0x1F) << 7) | (0b000 << 4) | src)
#define LSRi(dst, src, i)                                                      \
  (AL | (0b000 << 25) | (0b1101 << 21) | (0 << 20) | (dst << 12) |             \
   ((i & 0x1F) << 7) | (0b010 << 4) | src)
#define ASRi(dst, src, i)                                                      \
  (AL | (0b000 << 25) | (0b1101 << 21) | (0 << 20) | (dst << 12) |             \
   ((i & 0x1F) << 7) | (0b100 << 4) | src)
#define RORi(dst, src, i)                                                      \
  (AL | (0b000 << 25) | (0b1101 << 21) | (0 << 20) | (dst << 12) |             \
   ((i & 0x1F) << 7) | (0b110 << 4) | src)
#define RRX(dst, src)                                                          \
  (AL | (0b000 << 25) | (0b1101 << 21) | (0 << 20) | (dst << 12) |             \
   (0b110 << 4) | src)

#define BIC(dst, src, reg)                                                     \
  (AL | (0b000 << 25) | (0b11100 << 20) | (src << 16) | (dst << 12) | reg)
...
#define LDRa(dst, base, off)                                                   \
  (AL | (0b011 << 25) | (0b1100 << 21) | (1 << 20) | base << 16 | dst << 12 |  \
   off)
#define LDRx(dst, base, off)                                                   \
  (AL | (0b011 << 25) | (0b1000 << 21) | (1 << 20) | base << 16 | dst << 12 |  \
   off)

#define LDRai(dst, base, off)                                                  \
  (AL | (0b010 << 25) | (0b1100 << 21) | (1 << 20) | base << 16 | dst << 12 |  \
   rimm(off))
#define LDRxi(dst, base, off)                                                  \
  (AL | (0b010 << 25) | (0b1000 << 21) | (1 << 20) | base << 16 | dst << 12 |  \
   rimm(off))
#define LDRxiw(dst, base, off)                                                 \
  (AL | (0b010 << 25) | (0b1001 << 21) | (1 << 20) | base << 16 | dst << 12 |  \
   rimm(off))

#define LDRTa(dst, base, off)                                                  \
  (AL | (0b011 << 25) | (0b0101 << 21) | (1 << 20) | base << 16 | dst << 12 |  \
   off)
#define LDRTx(dst, base, off)                                                  \
  (AL | (0b011 << 25) | (0b0001 << 21) | (1 << 20) | base << 16 | dst << 12 |  \
   off)
#define LDRTai(dst, base, off)                                                 \
  (AL | (0b010 << 25) | (0b0101 << 21) | (1 << 20) | base << 16 | dst << 12 |  \
   rimm(off))
#define LDRTxi(dst, base, off)                                                 \
  (AL | (0b010 << 25) | (0b0001 << 21) | (1 << 20) | base << 16 | dst << 12 |  \
   rimm(off))

#define LDRBa(dst, base, off)                                                  \
  (AL | (0b011 << 25) | (0b1110 << 21) | (1 << 20) | base << 16 | dst << 12 |  \
   off)
#define LDRSBai(dst, base, off)                                                \
  (AL | (0b000 << 25) | (0b0110 << 21) | (1 << 20) | base << 16 | dst << 12 |  \
   ((off & 0xF0) << 4) | 0b1101 << 4 | (off & 0x0F))
#define STRBa(dst, base, off)                                                  \
  (AL | (0b011 << 25) | (0b1110 << 21) | (0 << 20) | base << 16 | dst << 12 |  \
   off)

#define LDRHa(dst, base, off)                                                  \
  (AL | (0b000 << 25) | (0b1100 << 21) | (1 << 20) | base << 16 | dst << 12 |  \
   (0b1011 << 4) | off)
#define LDRSHai(dst, base, off)                                                \
  (AL | (0b000 << 25) | (0b1110 << 21) | (1 << 20) | base << 16 | dst << 12 |  \
   ((off & 0xF0) << 4) | 0b1111 << 4 | (off & 0x0F))
#define STRHa(dst, base, off)                                                  \
  (AL | (0b000 << 25) | (0b1100 << 21) | (0 << 20) | base << 16 | dst << 12 |  \
   (0b1011 << 4) | off)

#define STRa(dst, base, off)                                                   \
  (AL | (0b011 << 25) | (0b1100 << 21) | (0 << 20) | base << 16 | dst << 12 |  \
   off)
#define STRx(dst, base, off)                                                   \
  (AL | (0b011 << 25) | (0b1000 << 21) | (0 << 20) | base << 16 | dst << 12 |  \
   off)
#define STRai(dst, base, off)                                                  \
  (AL | (0b010 << 25) | (0b1100 << 21) | (0 << 20) | base << 16 | dst << 12 |  \
   rimm(off))
#define STRxi(dst, base, off)                                                  \
  (AL | (0b010 << 25) | (0b1000 << 21) | (0 << 20) | base << 16 | dst << 12 |  \
   rimm(off))
#define STRaiw(dst, base, off)                                                 \
  (AL | (0b010 << 25) | (0b1101 << 21) | (0 << 20) | base << 16 | dst << 12 |  \
   rimm(off))
#define STRxiw(dst, base, off)                                                 \
  (AL | (0b010 << 25) | (0b1001 << 21) | (0 << 20) | base << 16 | dst << 12 |  \
   rimm(off))

// load with post-increment
#define POP1(reg)                                                              \
  (AL | (0b010 << 25) | (0b0100 << 21) | (1 << 20) | SP << 16 | reg << 12 | reg)
// store with post-increment
#define PUSH1(reg)                                                             \
  (AL | (0b010 << 25) | (0b1001 << 21) | (0 << 20) | SP << 16 | reg << 12 | 4)
...
#define BX(reg)                                                                \
  (AL | 0b00010010 << 20 | 0b1111 << 16 | 0b1111 << 12 | 0b1111 << 8 |         \
   0b0001 << 4 | reg)
...
#define PUSH(mask)                                                             \
  (AL | (0b100100 << 22) | (0b10 << 20) | (0b1101 << 16) | mask)
#define PUSH2(r1, r2)                                                          \
  (AL | (0b100100 << 22) | (0b10 << 20) | (0b1101 << 16) | 1 << r1 | 1 << r2)
//#define PUSH1(reg) STRxiw(SP, reg, 4)

#define POP(mask) (0xe8bd0000 | mask)

#define STM(base, regs)                                                        \
  (AL | 0b100 << 25 | 0 << 24 /*P*/ | 0 << 24 /*U*/ | 0 << 24 /*S*/ |          \
   0 << 24 /*W*/ | (base << 16) | (regs & ~(1 << 16)))

// note: op1 and op2 must not be the same
#define MUL(op1, op2, op3)                                                     \
  (AL | 0b0000000 << 21 | (1 << 20) /*S*/ | (op1 << 16) | (op3 << 8) |         \
   0b1001 << 4 | (op2))
...
#define VMOVass(Vn, Rt)                                                        \
  (AL | (0b1110 << 24) | (0b000 << 21) | (0 << 20) | ((Vn >> 1) << 16) |       \
   (Rt << 12) | (0b1010 << 8) | ((Vn & 1) << 7) | (1 << 4))
// singe precision register -> arm core register
#define VMOVssa(Rt, Vn)                                                        \
  (AL | (0b1110 << 24) | (0b000 << 21) | (1 << 20) | ((Vn >> 1) << 16) |       \
   (Rt << 12) | (0b1010 << 8) | ((Vn & 1) << 7) | (1 << 4))

#define _VCVT_F(Vd, Vm, opc2, op)                                              \
  (AL | (0b11101 << 23) | ((Vd & 1) << 22) | (0b111 << 19) | (opc2 << 16) |    \
   ((Vd >> 1) << 12) | (0b101 << 9) | (0 << 8) | (op << 7) | (1 << 6) |        \
   ((Vm & 1) << 5) | (Vm >> 1))
...
#define VLDRa(Vd, Rn, i)                                                       \
  (AL | (0b1101 << 24) | 1 << 23 | ((Vd & 1) << 22) | 1 << 20 | (Rn << 16) |   \
   ((Vd >> 1) << 12) | (0b1010 << 8) | off8(i))
#define VSTRa(Vd, Rn, i)                                                       \
  (AL | (0b1101 << 24) | 1 << 23 | ((Vd & 1) << 22) | 0 << 20 | (Rn << 16) |   \
   ((Vd >> 1) << 12) | (0b1010 << 8) | off8(i))

#define VNEG_F32(Vd, Vm)                                                       \
  (AL | (0b11101 << 23) | ((Vd & 1) << 22) | (0b11 << 20) | (1 << 16) |        \
   ((Vd >> 1) << 12) | (0b101 << 9) | (0 << 8) | (1 << 6) | ((Vm & 1) << 5) |  \
   (Vm >> 1))

#define VADD_F32(Vd, Vn, Vm)                                                   \
  (AL | (0b11100 << 23) | ((Vd & 1) << 22) | (0b11 << 20) |                    \
   ((Vn >> 1) << 16) | ((Vd >> 1) << 12) | (0b101 << 9) | (0 << 8) |           \
   ((Vn & 1) << 7) | (0 << 6) | ((Vm & 1) << 5) | (Vm >> 1))
#define VSUB_F32(Vd, Vn, Vm)                                                   \
  (AL | (0b11100 << 23) | ((Vd & 1) << 22) | (0b11 << 20) |                    \
   ((Vn >> 1) << 16) | ((Vd >> 1) << 12) | (0b101 << 9) | (0 << 8) |           \
   ((Vn & 1) << 7) | (1 << 6) | ((Vm & 1) << 5) | (Vm >> 1))
#define VMUL_F32(Vd, Vn, Vm)                                                   \
  (AL | (0b11100 << 23) | ((Vd & 1) << 22) | (0b10 << 20) |                    \
   ((Vn >> 1) << 16) | ((Vd >> 1) << 12) | (0b101) << 9 | (0 << 8) |           \
   ((Vn & 1) << 7) | (0 << 6) | ((Vm & 1) << 5) | (Vm >> 1))
#define VDIV_F32(Vd, Vn, Vm)                                                   \
  (AL | (0b11101 << 23) | ((Vd & 1) << 22) | (0b00 << 20) |                    \
   ((Vn >> 1) << 16) | ((Vd >> 1) << 12) | (0b101 << 9) | (0 << 8) |           \
   ((Vn & 1) << 7) | (0 << 6) | ((Vm & 1) << 5) | (Vm >> 1))

#define _VCMP_F32(Vd, Vm, E)                                                   \
  (AL | (0b11101 << 23) | ((Vd & 1) << 22) | (0b11 << 20) | ((0b0100) << 16) | \
   ((Vd >> 1) << 12) | (0b101 << 9) | (0 << 8) | (E << 7) | (1 << 6) |         \
   ((Vm & 1) << 5) | (Vm >> 1))
#define VCMP_F32(Vd, Vm) _VCMP_F32(Vd, Vm, 0)

#define VMRS(Rt)                                                               \
  (AL | (0b11101111 << 20) | (0b0001 << 16) | (Rt << 12) | (0b1010 << 8) |     \
   (1 << 4))
...
#define IJ(comparator)                                                         \
  do {                                                                         \
    ...
    emit(CMP(R1, R0));                                                         \
    emit(cond(comparator,                                                      \
              Bi(j_rel(vm->instructionPointers[arg.i] - vm->codeLength))));    \
  } while (0)
...
#define OFFSET(i)                                                              \
  (pass ? (j_rel(codeoffsets[i] - vm->codeLength)) : (0xF000000F))
...
#define OFF_IMMEDIATES 1
  ...
  for (pass = 0; pass < 2; ++pass) {
    ...
    emit(MOV(rOPSTACK,
             R2)); // TODO: reverse opstack to avoid writing to return address
    ...
    for (i_count = 0; i_count < header->instructionCount; i_count++) {
      ...
      if (vm_opInfo[op] & opImm4) {
        ...
        Com_Printf("%d: instruction %d (%s %d), offset %d\n", pass, i_count,
                   opnames[op], arg.i, vm->codeLength);
#endif
      ...
      case OP_CALL:
...
#endif
        {
          ...
          emit(BLX(R0));
          emit(
              Bi(j_rel(vm->instructionPointers[i_count + 1] - vm->codeLength)));
          if (bytes_to_skip == -1)
  ...
  if (mprotect(vm->codeBase, vm->codeLength,
