...
static void CG_PlayerSprites(centity_t* cent)
{
    ...
    if (cent->currentState.number == cg.snap->ps.clientNum && cg.renderingThirdPerson && CG_IsThirdPersonFollowMode(VRFM_QUERY)) {
...
void CG_Player(centity_t* cent)
{
    ...
    qboolean firstPersonBody = (cent->currentState.number == cg.snap->ps.clientNum) && (!cg.renderingThirdPerson) && (cg_firstPersonBodyScale.value > 0.0f);
